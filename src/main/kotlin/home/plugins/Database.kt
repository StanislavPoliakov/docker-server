...
fun Application.configureDatabase() {
    val database = environment.config.propertyOrNull("ktor.database.name")?.getString().takeUnless { it.isNullOrEmpty() }?.let {
        val jdbcUrl = environment.config.property("ktor.database.jdbcPostgresURL").getString()
